"""
doors script - Advanced Game Cheat Engine
Repository: Doors-Script-2026-Esp-Aimbot
License: MIT
"""
import sys
import time
...
class ESPAimbot:
    ...
    def find_best_aim_target(self, objects) -> Optional[dict]:
        ...
        for ply in objects:
            ...
            if aim_target:
                fov = ESPAimHelper.calculate_angle(self.get_local_pos(), aim_target)[0]
    ...
    def aim_at(self, player_data):
        ...
        aim_target_angle = ESPAimHelper.calculate_angle(local_pos, aim_target)
        current_angle = self.get_view_angles()
        new_angle = ESPAimHelper.smooth_angle(current_angle, aim_target_angle, self.smooth)
